...
public class MainDisplay_5Controller implements Initializable {
    ...
    private void handleBtnMenu(ActionEvent e) {
        if (btnMenu.getUserData().equals("close")) {
            ...
            //Control 버튼 이동
            KeyValue keyValue3 = new KeyValue(btnControl.translateXProperty(), -120);
            ...
            //Lcck 버튼 이동
            KeyValue keyValue5 = new KeyValue(btnLock.translateXProperty(), 120);
            ...
            //Setting 버튼 이동
            KeyValue keyValue7 = new KeyValue(btnSetting.translateXProperty(), 240);
