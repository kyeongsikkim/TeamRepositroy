...
public class MainDisplay_4Controller implements Initializable {
    ...
    private void handleBtnMenu(ActionEvent e) {
        if (btnMenu.getUserData().equals("close")) {
            ...
            //Call 버튼 이동
            KeyValue keyValue1 = new KeyValue(btnCall.translateXProperty(), -150);
            KeyValue keyValue2 = new KeyValue(btnCall.translateYProperty(), -15);
            ...
            KeyValue keyValue4 = new KeyValue(btnControl.translateYProperty(), -100);
            ...
            KeyValue keyValue6 = new KeyValue(btnLock.translateYProperty(), -100);
            ...
            //Setting 버튼 이동
            KeyValue keyValue7 = new KeyValue(btnSetting.translateXProperty(), 150);
            KeyValue keyValue8 = new KeyValue(btnSetting.translateYProperty(), -15);
