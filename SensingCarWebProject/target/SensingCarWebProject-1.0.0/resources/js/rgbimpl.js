...
//	};
	...
	Color.prototype.getRGBA = function getRGBA() {
		...
		if(this.r == "193" && this.g == "66" && this.b == "66") {
			var redJson = $("#redH").val();
			var greenJson = $("#greenH").val();
			var blueJson = $("#blueH").val();
		} else {
		 var redJson = this.r;
		 var greenJson = this.g;
		 var blueJson = this.b;
		}
		...
		$.ajax({
			url : "http://" + location.host + "/SensingCarWebProject/rgbled",
			data : json,
			method : "post"
		});
